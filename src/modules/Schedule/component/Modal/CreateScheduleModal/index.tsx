...
import { createSchedule, fetchRooms } from "@/modules/Room/actions/room.action"
...
type TCreateScheduleModalModal = {
  fetchSchedules: () => void
}

export function CreateScheduleModal({ fetchSchedules }: TCreateScheduleModalModal) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      await createSchedule({ id: values.room_id, ...values });
